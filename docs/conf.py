# pytest-run-parallel documentation build configuration file, created by
...
project = 'pytest-run-parallel'
copyright = '2015, Quansight Labs'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-run-parallel Documentation',
     [author], 1)
]
